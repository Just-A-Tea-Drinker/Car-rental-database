...
CREATE TABLE IF NOT EXISTS `parts_used` (
  ...
  INDEX `Mechanic_Signed_Out` (`Mechanic_Signed_Out` ASC),
...
CREATE TABLE IF NOT EXISTS `detailed_maintenance` (
  ...
  INDEX `Parts_used` (`Parts_used` ASC),
...
CREATE TABLE IF NOT EXISTS `Maintenance` (
  ...
  PRIMARY KEY (`Maintenance_ID`),
  INDEX `Vehicle_ID` (`Vehicle` ASC),
  INDEX `Sign_Off_Mechanic` (`Sign_Off_Mechanic` ASC),
  INDEX `Detailed_maintenance_ID` (`Detailed_maintenance_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `vehicle` (
  ...
  INDEX `vehicle_ibfk_1_idx` (`Vehicle_Type` ASC),
  INDEX `vehicle_ibfk_2_idx` (`Rate` ASC),
...
CREATE TABLE IF NOT EXISTS `trip_bill` (
  ...
  PRIMARY KEY (`Bill_ID`),
  INDEX `department_reservation_idx` (`Department_For` ASC),
  INDEX `enccured_by_idx` (`Encurred_by` ASC),
  INDEX `Vehicle_id_idx` (`Vehicle_Used` ASC),
...
CREATE TABLE IF NOT EXISTS `reservations` (
  ...
  INDEX `After_trip_form_ID` (`After_trip_form_ID` ASC),
  INDEX `Trip_bill_ID` (`Trip_bill_ID` ASC),
  INDEX `vehicle_used_idx` (`Vehicle` ASC),
